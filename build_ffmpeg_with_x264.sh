#!/bin/bash
#配置NDK路径
export NDK=/home/csz/Acer/ffmpeg/package/android-ndk-r13b
# 检测NDK
if [[  -z "$NDK"  ]]; then
...
#编译ffmpeg，编译为多个静态库#
FFMPEG_SOURCE_DIR=ffmpeg-4.0.1
...
#执行ndk-build
$NDK/ndk-build NDK_PROJECT_PATH=. APP_BUILD_SCRIPT=./Android.mk NDK_APPLICATION_MK=./Application.mk
